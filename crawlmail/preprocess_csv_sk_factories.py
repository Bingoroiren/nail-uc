...
INPUT_CSV = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "slovakia_factories.csv")
BACKUP_CSV = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "slovakia_factories_backup.csv")
...
def preprocess():
    ...
    ALLOWED_CATEGORIES = {
        ...
        "Výrobca autodielov",
        "Výrobca",
        "Dodávateľ železobetónových konštrukcií",
        "Chemický závod",
        ...
        "Výrobca elektroniky",
        "Kovovýroba",
        "Dodávateľ výrobkov z plastu",
        "Spoločnosť vyrábajúca plastové diely",
        "Služby vstrekovania plastov",
        "Dodávateľ výrobkov z gumy",
        "Výrobca batérií",
        "Sklad",
