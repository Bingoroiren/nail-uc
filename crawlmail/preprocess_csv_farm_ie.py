...
INPUT_CSV = os.path.join(BASE_DIR, "farm_ireland.csv")
BACKUP_CSV = os.path.join(BASE_DIR, "farm_ireland_backup.csv")

# Allowed Ireland Farm & Agriculture Category Tags (Strict Filtering)
ALLOWED_CATEGORIES = {
    "farm",
    "dairy farm",
    "honey farm",
