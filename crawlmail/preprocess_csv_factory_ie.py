...
INPUT_CSV = os.path.join(BASE_DIR, "factory_ireland.csv")
BACKUP_CSV = os.path.join(BASE_DIR, "factory_ireland_backup.csv")

# Allowed Ireland Factory & Electronics/Semiconductor Category Tags (Strict Filtering)
ALLOWED_CATEGORIES = {
    "manufacturer",
