...
INPUT_CSV  = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "metal_latvia.csv")
BACKUP_CSV = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "metal_latvia_backup.csv")
