...
INPUT_CSV = os.path.join(BASE_DIR, "meat_ireland.csv")
BACKUP_CSV = os.path.join(BASE_DIR, "meat_ireland_backup.csv")

# Allowed Ireland Meat Processing & Food Category Tags (Strict Filtering)
ALLOWED_CATEGORIES = {
    "food manufacturer",
    "meat processor",
