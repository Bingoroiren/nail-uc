...
INPUT_CSV = os.path.join(BASE_DIR, "hotel_ireland.csv")
BACKUP_CSV = os.path.join(BASE_DIR, "hotel_ireland_backup.csv")

# Allowed Ireland Hotel & Hospitality Category Tags (Strict Filtering)
ALLOWED_CATEGORIES = {
    "5-star hotel",
    "4-star hotel",
    "3-star hotel",
