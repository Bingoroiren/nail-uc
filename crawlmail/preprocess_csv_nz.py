...
INPUT_CSV = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "nail_salons_newzealand.csv")
BACKUP_CSV = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "nail_salons_newzealand_backup.csv")
...
def preprocess():
    ...
    # Handle extra fields (e.g. Permanently_Closed appended to older CSV file structure)
