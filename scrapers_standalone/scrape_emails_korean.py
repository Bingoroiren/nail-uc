...
async def main_async():
    input_file = os.path.join(ROOT_DIR, "data", "raw", "kofa_members.csv")
    output_file = os.path.join(ROOT_DIR, "data", "formatted", "kofa_members_with_emails.csv")
    output_xlsx = os.path.join(ROOT_DIR, "data", "formatted", "kofa_members_with_emails.xlsx")
