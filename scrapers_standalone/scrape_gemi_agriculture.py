...
OUTPUT_CSV = os.path.join(ROOT_DIR, "data", "raw", "gemi_agriculture_companies.csv")
...
async def main():
    print("="*70)
    print("  GEMI GREECE - BỘ CÀO THÔNG TIN CÔNG TY NÔNG LÂM THỦY SẢN (AGRICULTURE)")
    print("="*70)
    ...
    async with async_playwright() as p:
        ...
        print(" 2. Tại ô 'Δραστηριότητα' (Activity), click chọn 'Α ΓΕΩΡΓΙΑ, ΔΑΣΟΚΟΜΙΑ ΚΑΙ ΑΛΙΕΙΑ'.")
