...
INPUT_CSV = "korean_agencies.csv"
OUTPUT_CSV = "korean_agencies_formatted.csv"
OUTPUT_XLSX = "korean_agencies_formatted.xlsx"
...
async def main():
    ...
    PROGRESS_FILE_EMAILS = "scraping_progress_korean_emails.json"
