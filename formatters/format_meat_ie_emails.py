...
CANDIDATES = [
    os.path.join(ROOT_DIR, "data", "formatted", "meat_ireland_with_emails.csv"),
    os.path.join(ROOT_DIR, "data", "raw", "meat_ireland.csv")
]
...
BUSINESS_PREFIXES = {
    ...
    'admin', 'office', 'hello', 'enquiries', 'procurement'
}
...
DISCARD_KEYWORDS = {
    'gov.ie', 'bordbia.ie', 'gemi'
}

# Category translations from English to Vietnamese for Meat & Food Processing
import urllib.parse
...
CATEGORY_TRANSLATIONS = {
    ...
    "meat processor": "Cơ sở chế biến thịt",
    "food processing company": "Công ty chế biến thực phẩm",
    "meat wholesaler": "Nhà bán buôn / Phân phối thịt",
    "manufacturer": "Nhà sản xuất",
    "meat packer": "Cơ sở đóng gói thịt",
    "butcher shop": "Cửa hàng thịt / Cửa hàng mổ xẻ thịt",
    "corporate office": "Văn phòng doanh nghiệp / Trụ sở chính",
    "food products supplier": "Nhà cung cấp sản phẩm thực phẩm",
    "food producer": "Nhà sản xuất thực phẩm",
    "meat product supplier": "Nhà cung cấp sản phẩm thịt",
    "slaughterhouse": "Lò mổ / Cơ sở giết mổ",
    "poultry store": "Cửa hàng gia cầm / Thực phẩm gia cầm",
    "food supplier": "Nhà cung cấp thực phẩm",
    "food broker": "Môi giới / Đại lý thực phẩm"
}

def translate_category(raw_cat):
    if not raw_cat:
        return "Chế biến thực phẩm & Thịt Ireland"
