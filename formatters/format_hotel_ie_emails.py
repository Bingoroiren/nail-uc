...
CANDIDATES = [
    os.path.join(ROOT_DIR, "data", "formatted", "hotel_ireland_with_emails.csv"),
    os.path.join(ROOT_DIR, "data", "raw", "hotel_ireland.csv")
]
...
CATEGORY_TRANSLATIONS = {
    ...
    "homestay": "Homestay / Nhà nghỉ gia đình",
    "guest house": "Nhà khách (Guest House)",
    "guesthouse": "Nhà khách (Guest House)",
