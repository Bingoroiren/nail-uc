...
CANDIDATES = [
    os.path.join(ROOT_DIR, "data", "formatted", "construction_ireland_with_emails.csv"),
    os.path.join(ROOT_DIR, "data", "raw", "construction_ireland.csv")
]
...
BUSINESS_PREFIXES = {
    ...
    'admin', 'office', 'hello', 'enquiries', 'build', 'construction'
}
...
CATEGORY_TRANSLATIONS = {
    ...
    "home builder": "Thầu xây dựng nhà ở",
    "custom home builder": "Thầu thiết kế & Xây dựng nhà ở theo yêu cầu",
    "modular home builder": "Thầu xây dựng nhà lắp ghép (Modular Home)",
    "general contractor": "Nhà thầu tổng hợp / Tổng thầu xây dựng",
    "shed builder": "Thầu thi công nhà kho / Nhà xưởng nhỏ",
    "building restoration service": "Dịch vụ trùng tu & Phục hồi công trình",
