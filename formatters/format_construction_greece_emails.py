...
CANDIDATES = [
    os.path.join(ROOT_DIR, "data", "raw", "Xây dựng Hy lạp - Raw.csv"),
    os.path.join(ROOT_DIR, "data", "raw", "gemi_construction_companies.csv"),
    os.path.join(ROOT_DIR, "data", "raw", "Xây dựng Hy lạp.xlsx")
]
