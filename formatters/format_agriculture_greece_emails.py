...
CANDIDATES = [
    os.path.join(ROOT_DIR, "data", "raw", "Nông lâm thủy sản Hy lạp - Raw.csv"),
    os.path.join(ROOT_DIR, "data", "raw", "gemi_agriculture_companies.csv"),
    os.path.join(ROOT_DIR, "data", "raw", "Nông lâm thủy sản Hy lạp.xlsx")
]
...
BUSINESS_PREFIXES = {
    ...
    'enquiries', 'manager', 'service', 'farm', 'agri', 'fish', 'forest'
}
...
def main():
    if not INPUT_FILE or not os.path.exists(INPUT_FILE):
        ...
        print("1. Chạy file cào trước (scrape_gemi_agriculture.py) để tạo file raw tự động.")
        print("2. Đặt file dữ liệu thô (Nông lâm thủy sản Hy lạp - Raw.csv hoặc Nông lâm thủy sản Hy lạp.xlsx) vào thư mục này.")
        print("="*70)
        return
