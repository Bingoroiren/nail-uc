...
CANDIDATES = [
    os.path.join(ROOT_DIR, "data", "formatted", "(chờ) khách sạn Hy Lạp - CleanData.csv"),
    os.path.join(ROOT_DIR, "data", "formatted", "hotel_greece_with_emails.csv"),
    os.path.join(ROOT_DIR, "data", "raw", "hotel_greece.csv")
]
