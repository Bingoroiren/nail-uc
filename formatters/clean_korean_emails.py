...
def main():
    input_file = os.path.join(ROOT_DIR, "data", "formatted", "kofa_members_with_emails.csv")
    output_file = os.path.join(ROOT_DIR, "data", "formatted", "kofa_members_with_emails_cleaned.csv")
    output_xlsx = os.path.join(ROOT_DIR, "data", "formatted", "kofa_members_with_emails_cleaned.xlsx")
