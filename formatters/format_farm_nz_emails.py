...
INPUT_CSV = os.path.join(os.path.dirname(os.path.abspath(__file__)), "farms_nz_with_emails.csv")
BACKUP_CSV = os.path.join(os.path.dirname(os.path.abspath(__file__)), "farms_nz_with_emails_backup.csv")
FORMATTED_CSV = os.path.join(os.path.dirname(os.path.abspath(__file__)), "farms_nz_with_emails_formatted.csv")
FORMATTED_V2_CSV = os.path.join(os.path.dirname(os.path.abspath(__file__)), "farms_nz_with_emails_formatted_v2.csv")
