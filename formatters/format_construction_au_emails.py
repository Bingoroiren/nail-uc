...
INPUT_CSV = os.path.join(os.path.dirname(os.path.abspath(__file__)), "construction_australia_with_emails.csv")
if len(sys.argv) > 1:
...
BUSINESS_PREFIXES = {
    ...
    'enquiries', 'manager', 'build', 'builder', 'construction'
}
...
CATEGORY_TRANSLATIONS = {
    "contractor": "Thầu xây dựng",
    "construction company": "Công ty xây dựng",
    "home builder": "Nhà thầu xây dựng nhà ở",
    "office refurbishment service": "Dịch vụ cải tạo văn phòng",
    "excavating contractor": "Nhà thầu đào móng / san lấp",
    "custom home builder": "Nhà thầu xây nhà theo yêu cầu"
}
