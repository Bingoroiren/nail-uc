...
BUSINESS_PREFIXES = {
    ...
    'enquiries', 'manager', 'service', 'sk', 'slovakia', 'recruitment', 'jobs'
}
...
CATEGORY_TRANSLATIONS = {
    ...
    "Agentúra pre sprostredkovanie práce": "Đại lý môi giới việc làm",
    "Sprostredkovanie práce": "Môi giới việc làm"
}
