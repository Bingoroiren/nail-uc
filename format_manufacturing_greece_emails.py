...
CANDIDATES = [
    os.path.join(SCRIPT_DIR, "Sản xuất Hy lạp - Raw.csv"),
    os.path.join(SCRIPT_DIR, "gemi_manufacturing_companies.csv"),
    os.path.join(SCRIPT_DIR, "Sản xuất Hy lạp.xlsx")
]
...
BUSINESS_PREFIXES = {
    ...
    'enquiries', 'manager', 'service', 'gemi', 'factory', 'manufacture', 'production'
}
