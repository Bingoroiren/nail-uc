...
BUSINESS_PREFIXES = {
    ...
    'sales', 'recepts', 'enquiries', 'manager', 'zivis', 'zivju', 'fish'
}
...
# Category translations from Latvian to Vietnamese
CATEGORY_TRANSLATIONS = {
    "zivju apstrādes uzņēmums": "Công ty chế biến cá",
    "ražotājs": "Nhà sản xuất",
    "konservu fabrika": "Nhà máy đồ hộp",
    "zivju ferma": "Trại cá",
    "akvakultūras ferma": "Trại nuôi trồng thủy sản",
    "jūras velšu vairumtirgotājs": "Nhà bán buôn hải sản"
}
...
def main():
    ...
    # Step 4: Reformat to the standard cold mail template columns
    fieldnames = [
