...
echo.
echo ======================================================
echo STEP 1: Launching Ireland Meat and Food Facilities Maps Scraper...
echo ======================================================
...
echo ======================================================
python crawlmail/email_scraper.py data/raw/meat_ireland.csv data/formatted/meat_ireland_with_emails.csv
if errorlevel 1 goto RunFailed
...
echo ======================================================
python formatters/format_meat_ie_emails.py
if errorlevel 1 goto RunFailed
