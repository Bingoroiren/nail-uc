...
title Norway Farms and Aquaculture Google Maps ^& Email Scraper Launcher
cd /d "%~dp0.."

echo ======================================================
echo       AUTOMATIC PYTHON SETUP AND SCRAPER RUN (FARM NORWAY)
echo ======================================================
...
echo.
echo ======================================================
echo STEP 1: Launching Norway Farms & Aquaculture Maps Scraper...
echo ======================================================
python -u src/scraper_farm_no.py %*
if errorlevel 1 goto RunFailed

echo.
echo ======================================================
echo STEP 2: Scrape Emails, Deduplicate and Translate Norwegian Tags...
echo ======================================================
python formatters/format_farm_no_emails.py
...
echo.
echo ======================================================
echo      NORWAY FARM SCRAPING SESSION TERMINATED
echo ======================================================
pause
