@echo off
title Slovakia Labor Recruitment Google Maps ^& Email Scraper Launcher
cd /d "%~dp0.."
set "PATH=C:\Users\PC\python311\tools;%PATH%"

echo ======================================================
echo         AUTOMATIC PYTHON SETUP AND SCRAPER RUN (SLOVAKIA RECRUITMENT)
echo ======================================================
...
echo ======================================================
echo STEP 1: Launching Slovakia Labor Recruitment Google Maps Scraper...
echo ======================================================
python -u src/scraper_sk.py
...
echo ======================================================
python crawlmail/preprocess_csv_sk.py
if errorlevel 1 goto RunFailed

echo.
echo ======================================================
echo STEP 3: Launching Email Scraper for Slovakia Recruitment...
echo ======================================================
python crawlmail/email_scraper.py data/raw/slovakia_recruitment.csv data/formatted/slovakia_recruitment_with_emails.csv
if errorlevel 1 goto RunFailed
...
echo.
echo ======================================================
echo     SLOVAKIA RECRUITMENT SCRAPING SESSION TERMINATED
echo ======================================================
pause
