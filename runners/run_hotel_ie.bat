...
echo ======================================================
echo         AUTOMATIC PYTHON SETUP AND SCRAPER RUN (HOTEL IE)
echo ======================================================
...
echo.
echo ======================================================
echo STEP 1: Launching Ireland Hotel Google Maps Scraper...
echo ======================================================
python -u src/scraper_hotel_ie.py %*
...
echo.
echo ======================================================
echo STEP 3: Launching Email Scraper for Ireland Hotels...
echo ======================================================
python crawlmail/email_scraper.py data/raw/hotel_ireland.csv data/formatted/hotel_ireland_with_emails.csv
if errorlevel 1 goto RunFailed
...
echo ======================================================
python formatters/format_hotel_ie_emails.py
if errorlevel 1 goto RunFailed
...
echo.
echo ======================================================
echo       IRELAND HOTEL SCRAPING SESSION TERMINATED
echo ======================================================
pause
