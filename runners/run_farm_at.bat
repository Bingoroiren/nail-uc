...
title Austria Farms and Agriculture Google Maps ^& Email Scraper Launcher
cd /d "%~dp0.."

echo ======================================================
echo       AUTOMATIC PYTHON SETUP AND SCRAPER RUN (FARM AUSTRIA)
echo ======================================================
...
echo.
echo ======================================================
echo STEP 1: Launching Austria Farms & Agriculture Maps Scraper...
echo ======================================================
python -u src/scraper_farm_at.py %*
...
echo.
echo ======================================================
echo      AUSTRIA FARM SCRAPING SESSION TERMINATED
echo ======================================================
pause
