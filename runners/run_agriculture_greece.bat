@echo off
title Greece Agriculture Company Email Formatter Launcher
cd /d "%~dp0.."
...
echo.
echo ======================================================
echo STEP: Formatting Greece Agriculture Emails...
echo ======================================================
python formatters/format_agriculture_greece_emails.py %*
...
echo.
echo ======================================================
echo       GREECE AGRICULTURE FORMATTING SESSION TERMINATED
echo ======================================================
pause
