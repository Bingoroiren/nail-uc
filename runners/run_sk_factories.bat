@echo off
title Slovakia Factory ^& Warehouse Google Maps ^& Email Scraper Launcher
cd /d "%~dp0.."
set "PATH=C:\Users\PC\python311\tools;%PATH%"

echo ======================================================
echo         AUTOMATIC PYTHON SETUP AND SCRAPER RUN (SLOVAKIA FACTORIES)
echo ======================================================
...
echo ======================================================
echo STEP 1: Launching Slovakia Factory Google Maps Scraper...
echo ======================================================
python -u src/scraper_sk_factories.py
...
echo ======================================================
python crawlmail/preprocess_csv_sk_factories.py
if errorlevel 1 goto RunFailed

echo.
echo ======================================================
echo STEP 3: Launching Email Scraper for Slovakia Factories...
echo ======================================================
python crawlmail/email_scraper.py data/raw/slovakia_factories.csv data/formatted/slovakia_factories_with_emails.csv
if errorlevel 1 goto RunFailed
...
echo.
echo ======================================================
echo     SLOVAKIA FACTORIES SCRAPING SESSION TERMINATED
echo ======================================================
pause
