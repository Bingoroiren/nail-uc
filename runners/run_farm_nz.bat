...
echo ======================================================
echo STEP 1: Launching New Zealand Farm Google Maps Scraper...
echo ======================================================
python -u src/scraper_farm_nz.py
if errorlevel 1 goto RunFailed

echo.
echo ======================================================
echo STEP 2: Preprocessing Scraped Farms...
echo ======================================================
python crawlmail/preprocess_csv_farm_nz.py
if errorlevel 1 goto RunFailed

echo.
echo ======================================================
echo STEP 3: Launching Email Scraper for New Zealand Farms...
echo ======================================================
python crawlmail/email_scraper.py data/raw/farms_newzealand.csv data/formatted/farms_nz_with_emails.csv
if errorlevel 1 goto RunFailed
...
echo ======================================================
python formatters/format_farm_nz_emails.py
if errorlevel 1 goto RunFailed
...
echo.
echo ======================================================
echo       NEW ZEALAND FARM SCRAPING SESSION TERMINATED
echo ======================================================
pause
