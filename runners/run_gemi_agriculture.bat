@echo off
title Greece GEMI Agriculture Company Scraper Launcher
cd /d "%~dp0.."
...
echo [*] Launching GEMI Greece Agriculture Scraper...
echo.

python scrapers_standalone/scrape_gemi_agriculture.py
goto End
