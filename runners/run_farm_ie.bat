...
title Ireland Farms and Agriculture Scraper Launcher
cd /d "%~dp0.."

echo ======================================================
echo       AUTOMATIC PYTHON SETUP AND SCRAPER RUN (FARM IE)
echo ======================================================
...
echo.
echo ======================================================
echo STEP 1: Launching Ireland Farms and Agriculture Maps Scraper...
echo ======================================================
python -u src/scraper_farm_ie.py %*
...
echo ======================================================
python crawlmail/preprocess_csv_farm_ie.py
if errorlevel 1 goto RunFailed

echo.
echo ======================================================
echo STEP 3: Launching Email Scraper for Ireland Farms...
echo ======================================================
python crawlmail/email_scraper.py data/raw/farm_ireland.csv data/formatted/farm_ireland_with_emails.csv
if errorlevel 1 goto RunFailed
...
echo ======================================================
python formatters/format_farm_ie_emails.py
if errorlevel 1 goto RunFailed
...
echo.
echo ======================================================
echo      IRELAND FARM SCRAPING SESSION TERMINATED
echo ======================================================
pause
