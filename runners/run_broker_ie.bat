...
echo ======================================================
echo       AUTOMATIC PYTHON SETUP AND SCRAPER RUN (BROKER IE)
echo ======================================================
...
echo.
echo ======================================================
echo STEP 3: Launching Email Scraper for Ireland Brokers...
echo ======================================================
python crawlmail/email_scraper.py data/raw/broker_ireland.csv data/formatted/broker_ireland_with_emails.csv
if errorlevel 1 goto RunFailed
...
echo ======================================================
python formatters/format_broker_ie_emails.py
if errorlevel 1 goto RunFailed
