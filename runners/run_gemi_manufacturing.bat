@echo off
title Greece GEMI Manufacturing Company Scraper Launcher
cd /d "%~dp0.."
...
echo [*] Launching GEMI Greece Manufacturing Scraper...
echo.

python scrapers_standalone/scrape_gemi_manufacturing.py
goto End
