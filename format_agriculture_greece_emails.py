...
CANDIDATES = [
    os.path.join(SCRIPT_DIR, "Nông lâm thủy sản Hy lạp - Raw.csv"),
    os.path.join(SCRIPT_DIR, "gemi_agriculture_companies.csv"),
    os.path.join(SCRIPT_DIR, "Nông lâm thủy sản Hy lạp.xlsx")
]
