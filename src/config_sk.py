...
# Google Maps Search Settings (Slovak recruitment terms)
KEYWORDS = [
    "Pracovná agentúra",
...
# Google Maps Category Filter (same tags)
ALLOWED_CATEGORIES = [
    "Pracovná agentúra",
    "Personálne poradenstvo",
    "Agentúra pre sprostredkovanie práce",
...
# Output settings
OUTPUT_CSV = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "raw", "slovakia_recruitment.csv")
