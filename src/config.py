...
# Output settings
OUTPUT_CSV = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "raw", "nail_salons_australia.csv")
...
# (Note: Google Maps uses dynamically generated CSS class names, so we rely heavily on stable attribute names where possible)
SELECTORS = {
